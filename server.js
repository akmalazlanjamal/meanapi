...
apiRouter.route('/users')
    ...
    // create a user (accessed at POST http://localhost:1234/api/users)
    ...
    // get all the users (accessed at GET http://localhost:1234/api/users)
...
apiRouter.route('/users/:user_id')
    ...
    // (accessed at GET http://localhost:1234/api/users/:user_id)
    .get(function (req, res) {
    ...
    // (accessed at PUT http://localhost:1234/api/users/:user_id)
